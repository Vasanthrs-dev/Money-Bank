...
const account2 = {
  owner: 'Tony Stark',
  movements: [50000, 344000, -150, -790, -32100, -1000, 8500, -30],
  interestRate: 1.5,
  pin: 2222,
...
const account3 = {
  owner: 'Peter Parker',
  movements: [456, 234, -23, -224, -235, 1200, -20, 30],
  interestRate: 1.5,
  pin: 3333,
...
const account4 = {
  owner: 'Steve Rogers',
  movements: [200, 2354, -56, 5000, -2035, 1200, -200, 300],
  interestRate: 1.7,
  pin: 4444,
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const currency = formatCurr(mov, acc.locale, acc.currency);
...
const calcDisplayBalance = function (acc) {
  ...
  const currency = formatCurr(acc.balance, acc.locale, acc.currency);
